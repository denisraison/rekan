...
var typeMap = map[string]reflect.Type{
	...
	"TYPES.CustomerCreateParams":          reflect.TypeOf(types.CustomerCreateParams{}),
	"STREAM_TYPES.CustomerCreateParams":   reflect.TypeOf(stream_types.CustomerCreateParams{}),
	"TYPES.CustomerInfoParams":            reflect.TypeOf(types.CustomerInfoParams{}),
	"STREAM_TYPES.CustomerInfoParams":     reflect.TypeOf(stream_types.CustomerInfoParams{}),
	"TYPES.CustomerPauseParams":           reflect.TypeOf(types.CustomerPauseParams{}),
	"STREAM_TYPES.CustomerPauseParams":    reflect.TypeOf(stream_types.CustomerPauseParams{}),
	"TYPES.CustomerUpdateParams":          reflect.TypeOf(types.CustomerUpdateParams{}),
	"STREAM_TYPES.CustomerUpdateParams":   reflect.TypeOf(stream_types.CustomerUpdateParams{}),
	...
	"TYPES.PostApproveParams":             reflect.TypeOf(types.PostApproveParams{}),
	"STREAM_TYPES.PostApproveParams":      reflect.TypeOf(stream_types.PostApproveParams{}),
	"TYPES.PostGenerateParams":            reflect.TypeOf(types.PostGenerateParams{}),
	"STREAM_TYPES.PostGenerateParams":     reflect.TypeOf(stream_types.PostGenerateParams{}),
	"TYPES.PostRejectParams":              reflect.TypeOf(types.PostRejectParams{}),
	"STREAM_TYPES.PostRejectParams":       reflect.TypeOf(stream_types.PostRejectParams{}),
