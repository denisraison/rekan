  ...
  const examples = [
    {
      ...
      caption:
        'Semana passada o forno de baixo apagou no meio da madrugada. 4h da manhã, 3 formas de bolo de cenoura dentro, a resistência simplesmente parou. Dona Elza olhou pra mim e disse: "Tira tudo, passa pro de cima, e reza." Queimei o dedo. O bolo? Saiu perfeito.',
    ...
    },
    {
      ...
      caption:
        'Ontem uma cliente sentou na cadeira e disse: "Lu, eu quero aquela francesinha que ninguém faz direito". Eu ouço isso pelo menos 3 vezes por semana. A real é que francesinha parece simples mas é técnica pura. Eu me formei em nail design justamente porque queria dominar esse detalhe. R$45 e sai com acabamento que parece filtro, mas é real.',
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Parceiro de conteúdo pro Instagram via WhatsApp. Você conta o que aconteceu no seu negócio e a gente escreve a legenda, as hashtags e o story. Para micro-empreendedores brasileiros."
  />
...
<nav class="nav">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a
        href={waLink('Oi, quero saber mais sobre o Rekan')}
        target="_blank"
        rel="noopener"
        class="btn btn-primary btn-sm">Começar</a
      >
    </div>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="hero-content">
    <div class="hero-text">
      ...
      <p class="hero-sub">
        O Rekan escreve legenda, hashtags e story pro Instagram do seu negócio. Descreve o que você
        faz uma vez e sai postando.
      </p>
      ...
      <div class="hero-cta">
        <a
          ...
          target="_blank"
          rel="noopener"
          class="btn btn-primary">Comece por R$ 69,90</a
        >
      ...
      <div class="wa-window">
        ...
        <div class="wa-body">
          ...
          <div class="wa-bubble wa-bubble--in">
            ...
            <p>
              Um por um, enrolado na mão, sem conservante nenhum. Separei em três encomendas e fui
              eu mesma entregar na casa de cada cliente aqui em BH.
            </p>
            <p>
              Tem dia que a cozinha fica assim: panela suja, bancada cheia de forminha e eu já
              pensando na próxima leva. Mas quando a cliente abre a porta e já sente o cheiro do
              chocolate, vale cada brigadeiro.
            </p>
            <p>Quer encomendar? Chama no zap, link tá na bio 📱</p>
            <p class="wa-hashtags">
              #DocesdaFlavinha #BrigadeiroArtesanal #DoceriaEmBH #Savassi #BeloHorizonte
              #SemConservantes #FeitoEmCasa
            </p>
...
<section class="showcase" id="exemplos" use:_reveal>
  <div class="showcase-inner">
    ...
    <p class="showcase-sub">
      A padaria mandou uma foto do bolo. O Rekan escreveu. Ela só colou no Instagram.
    </p>
...
<section class="pricing" id="preco" use:_reveal>
  <div class="pricing-inner">
    ...
    <div class="commitment-toggle">
      <button
        class="toggle-option"
        class:active={commitment === 'mensal'}
        onclick={() => {
          commitment = 'mensal';
        }}>Mensal</button
      >
      <button
        class="toggle-option"
        class:active={commitment === 'trimestral'}
        onclick={() => {
    ...
    <div class="pricing-grid">
      <div class="tier-card">
        ...
        <div class="tier-price">
          ...
          <span class="tier-value"
            >{commitment === 'mensal'
              ? fmt(prices.basico.mensal)
              : monthly(prices.basico.trimestral)}</span
          >
        ...
        <a
          href={waLink(`Oi, quero o plano Básico ${commitment}`)}
          target="_blank"
          rel="noopener"
          class="btn btn-ghost btn-block">Começar</a
        >
      </div>
      <div class="tier-card tier-card--featured">
        ...
        <div class="tier-price">
          ...
          <span class="tier-value"
            >{commitment === 'mensal'
              ? fmt(prices.parceiro.mensal)
              : monthly(prices.parceiro.trimestral)}</span
          >
          <span class="tier-period">/mês</span>
        </div>
        ...
        <a
          href={waLink(`Oi, quero o plano Parceiro ${commitment}`)}
          target="_blank"
          rel="noopener"
          class="btn btn-primary btn-block">Começar agora</a
        >
        <p class="tier-daily">
          {commitment === 'mensal' ? 'Menos de R$4 por dia' : 'Menos de R$3,50 por dia'}
        </p>
      </div>
      <div class="tier-card">
        ...
        <div class="tier-price">
          ...
          <span class="tier-value"
            >{commitment === 'mensal'
              ? fmt(prices.profissional.mensal)
              : monthly(prices.profissional.trimestral)}</span
          >
          <span class="tier-period">/mês</span>
        </div>
        {#if commitment === 'trimestral'}
        ...
        <a
          href={waLink(`Oi, quero o plano Profissional ${commitment}`)}
          target="_blank"
          rel="noopener"
          class="btn btn-ghost btn-block">Começar</a
        >
...
<section class="final-cta">
  <div class="final-cta-inner">
    ...
    <a
      ...
      target="_blank"
      rel="noopener"
      class="btn btn-white">Comece agora</a
    >
  </div>
</section>
...
<footer class="footer">
  <div class="footer-inner">
    <div
      class="footer-logo"
      style="--mark-coral: rgba(255,255,255,0.5); --mark-sage: rgba(255,255,255,0.3); --text: rgba(255,255,255,0.6)"
    >
      <LogoCombo height={24} />
    </div>
...
<style>
  ...
  .hero-mesh-1 {
    ...
    background: radial-gradient(
      circle,
      rgba(249, 115, 104, 0.22) 0%,
      rgba(249, 115, 104, 0.08) 35%,
      transparent 60%
    );
    top: -20%;
    right: -10%;
  ...
  .hero-mesh-2 {
    ...
    background: radial-gradient(
      circle,
      rgba(135, 170, 140, 0.18) 0%,
      rgba(135, 170, 140, 0.06) 35%,
      transparent 60%
    );
    bottom: -15%;
    left: -10%;
  ...
  .hero-visual .wa-window {
    width: 100%;
    box-shadow:
      0 32px 80px rgba(17, 17, 22, 0.18),
      0 8px 24px rgba(17, 17, 22, 0.1);
  }
  ...
  .empathy:global(.visible) .empathy-line:nth-child(1) {
    transition-delay: 0s;
  }
  .empathy:global(.visible) .empathy-line:nth-child(2) {
    transition-delay: 0.15s;
  }
  .empathy:global(.visible) .empathy-line:nth-child(3) {
    transition-delay: 0.3s;
  }
  .empathy:global(.visible) .empathy-question {
  ...
  .post-image-wrap {
    ...
    overflow: hidden;
    box-shadow:
      0 8px 32px rgba(17, 17, 22, 0.1),
      0 2px 8px rgba(17, 17, 22, 0.06);
    margin-bottom: 16px;
