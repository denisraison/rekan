  ...
  <div class="w-full max-w-md">
    ...
    {:else if invite?.invite_status === 'active'}
      ...
      >
        ...
        <p class="text-sm mb-4" style="color: var(--text-secondary)">
          Pagamento confirmado. O Rekan já está pronto para gerar conteúdo para o seu negócio. Em
          breve você receberá seus primeiros posts pelo WhatsApp.
        </p>
        <a
      ...
      >
        {#if timedOut}
          <div class="text-center">
            ...
            <p class="text-sm mb-4" style="color: var(--text-secondary)">
              Se você já realizou o pagamento, pode levar alguns minutos para a confirmação. Caso
              tenha dúvidas, fale com a gente.
            </p>
            <a
    ...
    {:else if invite?.invite_status === 'invited'}
      ...
      >
        ...
        <p class="text-sm mb-1" style="color: var(--text-secondary)">
          Plano <strong>{tierNames[invite.tier] ?? invite.tier}</strong> ({commitmentNames[
            invite.commitment
          ] ?? invite.commitment}): <strong>{priceDescription()}</strong>.
        </p>
        ...
        <div class="flex flex-col gap-4">
          <label class="flex flex-col gap-1.5">
            ...
            <input
              ...
              style="border-color: {cpfCnpjError
                ? '#DC2626'
                : 'var(--border-strong)'}; background: var(--surface); color: var(--text); font-family: var(--font-primary)"
            />
            {#if cpfCnpjError}
          ...
          <label class="flex items-start gap-2 cursor-pointer">
            ...
            <span class="text-sm" style="color: var(--text-secondary)">
              Li e aceito os <a
                ...
                rel="noopener"
                class="underline"
                style="color: var(--coral)">Termos de Uso</a
              >
            </span>
          </label>
