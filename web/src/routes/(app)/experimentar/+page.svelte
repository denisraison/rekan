...
<div class="min-h-screen flex flex-col items-center px-4 py-8" style="background: var(--bg)">
    ...
    <div class="flex flex-col gap-4">
      ...
      <label class="flex flex-col gap-1.5">
        <span class="text-sm font-medium" style="color: var(--text)"
          >Serviços <span class="font-normal" style="color: var(--text-muted)">— opcional</span
          ></span
        >
        <input
          bind:value={services}
